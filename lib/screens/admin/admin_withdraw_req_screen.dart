            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Text('e.g. 60 ads = 13 💎 → auto-calculates 120=26, 180=39...', style: AppText.caption(size: 11)),
                  ...
                  _numField(adsController, 'Ads Required (e.g. 60)'),
                  const SizedBox(height: 10),
                  _numField(givenController, 'Currency Given per cycle (e.g. 13)'),
                  const SizedBox(height: 10),
                  _numField(targetController, 'Target ceiling (e.g. 260)'),
                  if (errorText != null) ...[
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            '$ads ads = ${given.toStringAsFixed(2)} · target ${target.toStringAsFixed(2)} · ${active ? "Active" : "Inactive"}',
